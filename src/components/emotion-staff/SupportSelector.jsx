    ...
    return (
        <div className="glass glass-card hover-lift transition-all duration-300">
            ...
            <div className="relative z-10 p-5 md:p-6 space-y-5">
              ...
              ${hasSelection
                                ? 'border-emerald shadow-lg shadow-emerald/10 bg-input/80'
                                : 'border-border hover:border-emerald/40 hover:bg-input/70'
                            }
              focus:outline-none focus:border-emerald focus:shadow-lg focus:shadow-emerald/10
            `}
                    >
              ...
              ${hasSelection ? 'text-emerald' : 'text-muted-foreground'}
            `} />
                    </div>
                </div>

                {/* Selected Person Card */}
                {selectedPerson && selectedPerson.id !== "no-need" && (
                    <div
