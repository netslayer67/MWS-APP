    ...
    <section className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
        {statCards.map((card, index) => {
            ...
            return (
                <div
                    key={card.label}
                    className={`group relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br ${style.gradient} p-3.5 sm:p-5 lg:p-6 ${style.glow} ${style.darkGlow} transition-transform duration-200 hover:-translate-y-1 hover:scale-[1.02]`}
                    data-aos="fade-up"
                ...
                >
                    ...
                    <div className="relative flex items-start justify-between gap-2">
                        <div className="min-w-0 flex-1">
                            {/* Label with fade-in */}
                            <p
                                className="text-[9px] sm:text-[10px] lg:text-[11px] font-bold uppercase tracking-[0.25em] sm:tracking-[0.35em] text-white/80 truncate animate-[mtssSlideUp_0.5s_ease-out_both]"
                            ...
                            {/* Animated number */}
                            <p
                                className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mt-1 sm:mt-2 drop-shadow-sm animate-[mtssSlideUp_0.6s_ease-out_both]"
                        ...
                        {/* Animated icon */}
                        <span
                            className={`${style.iconBg} flex-shrink-0 w-9 h-9 sm:w-11 sm:h-11 lg:w-[3.25rem] lg:h-[3.25rem] rounded-xl sm:rounded-2xl inline-flex items-center justify-center text-white animate-[mtssIconPop_0.6s_ease-out_both] group-hover:animate-[mtssIconWiggle_0.5s_ease-in-out]`}
