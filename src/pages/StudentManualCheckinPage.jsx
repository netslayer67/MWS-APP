...
const weatherOptions = [
    { icon: Sun, label: "Sunny & Clear", value: "sunny", gradient: "from-[var(--cw-sunny-from)] via-[var(--cw-sunny-via)] to-[var(--cw-sunny-to)]", iconTone: "text-amber-600" },
    { icon: Cloud, label: "Partly Cloudy", value: "partly-cloudy", gradient: "from-[var(--cw-partly-cloudy-from)] via-[var(--cw-partly-cloudy-via)] to-[var(--cw-partly-cloudy-to)]", iconTone: "text-slate-500" },
    { icon: CloudRain, label: "Light Rain", value: "light-rain", gradient: "from-[var(--cw-light-rain-from)] via-[var(--cw-light-rain-via)] to-[var(--cw-light-rain-to)]", iconTone: "text-sky-600" },
    { icon: Zap, label: "Thunderstorms", value: "thunderstorms", gradient: "from-[var(--cw-thunderstorms-from)] via-[var(--cw-thunderstorms-via)] to-[var(--cw-thunderstorms-to)]", iconTone: "text-orange-600" },
    { icon: Tornado, label: "Chaotic", value: "tornado", gradient: "from-[var(--cw-tornado-from)] via-[var(--cw-tornado-via)] to-[var(--cw-tornado-to)]", iconTone: "text-slate-600" },
    { icon: Snowflake, label: "Snowy & Still", value: "snowy", gradient: "from-[var(--cw-snowy-from)] via-[var(--cw-snowy-via)] to-[var(--cw-snowy-to)]", iconTone: "text-sky-600" },
    { icon: Rainbow, label: "Rainbow", value: "rainbow", gradient: "from-[var(--cw-rainbow-from)] via-[var(--cw-rainbow-via)] to-[var(--cw-rainbow-to)]", iconTone: "text-indigo-500" },
    { icon: CloudFog, label: "Foggy", value: "foggy", gradient: "from-[var(--cw-foggy-from)] via-[var(--cw-foggy-via)] to-[var(--cw-foggy-to)]", iconTone: "text-slate-500" },
    { icon: Flame, label: "Heatwave", value: "heatwave", gradient: "from-[var(--cw-heatwave-from)] via-[var(--cw-heatwave-via)] to-[var(--cw-heatwave-to)]", iconTone: "text-rose-500" },
    { icon: Wind, label: "Windy", value: "windy", gradient: "from-[var(--cw-windy-from)] via-[var(--cw-windy-via)] to-[var(--cw-windy-to)]", iconTone: "text-cyan-600" },
];

const moodOptions = [
    { icon: Smile, label: "Happy", value: "happy", gradient: "from-[var(--cm-happy-from)] via-[var(--cm-happy-via)] to-[var(--cm-happy-to)]", iconTone: "text-amber-700", tagline: "Bright energy" },
    { icon: Zap, label: "Excited", value: "excited", gradient: "from-[var(--cm-excited-from)] via-[var(--cm-excited-via)] to-[var(--cm-excited-to)]", iconTone: "text-rose-600", tagline: "Ready to shine" },
    { icon: HeartPulse, label: "Calm", value: "calm", gradient: "from-[var(--cm-calm-from)] via-[var(--cm-calm-via)] to-[var(--cm-calm-to)]", iconTone: "text-emerald-600", tagline: "Steady and grounded" },
    { icon: Sparkles, label: "Hopeful", value: "hopeful", gradient: "from-[var(--cm-hopeful-from)] via-[var(--cm-hopeful-via)] to-[var(--cm-hopeful-to)]", iconTone: "text-indigo-500", tagline: "Looking ahead" },
    { icon: Frown, label: "Sad", value: "sad", gradient: "from-[var(--cm-sad-from)] via-[var(--cm-sad-via)] to-[var(--cm-sad-to)]", iconTone: "text-blue-600", tagline: "Need a lift" },
    { icon: AlertCircle, label: "Anxious", value: "anxious", gradient: "from-[var(--cm-anxious-from)] via-[var(--cm-anxious-via)] to-[var(--cm-anxious-to)]", iconTone: "text-indigo-500", tagline: "A bit on edge" },
    { icon: Flame, label: "Angry", value: "angry", gradient: "from-[var(--cm-angry-from)] via-[var(--cm-angry-via)] to-[var(--cm-angry-to)]", iconTone: "text-rose-600", tagline: "Feeling intense" },
    { icon: Shield, label: "Fear", value: "fear", gradient: "from-[var(--cm-fear-from)] via-[var(--cm-fear-via)] to-[var(--cm-fear-to)]", iconTone: "text-slate-600", tagline: "Feeling uneasy" },
    { icon: Brain, label: "Overwhelmed", value: "overwhelmed", gradient: "from-[var(--cm-overwhelmed-from)] via-[var(--cm-overwhelmed-via)] to-[var(--cm-overwhelmed-to)]", iconTone: "text-violet-600", tagline: "Too much at once" },
    { icon: Moon, label: "Tired", value: "tired", gradient: "from-[var(--cm-tired-from)] via-[var(--cm-tired-via)] to-[var(--cm-tired-to)]", iconTone: "text-slate-600", tagline: "Low energy" },
    { icon: Coffee, label: "Hungry", value: "hungry", gradient: "from-[var(--cm-hungry-from)] via-[var(--cm-hungry-via)] to-[var(--cm-hungry-to)]", iconTone: "text-amber-700", tagline: "Need a boost" },
    { icon: Users, label: "Lonely", value: "lonely", gradient: "from-[var(--cm-lonely-from)] via-[var(--cm-lonely-via)] to-[var(--cm-lonely-to)]", iconTone: "text-sky-600", tagline: "Want connection" },
    { icon: XCircle, label: "Bored", value: "bored", gradient: "from-[var(--cm-bored-from)] via-[var(--cm-bored-via)] to-[var(--cm-bored-to)]", iconTone: "text-slate-500", tagline: "Low motivation" },
    { icon: Shuffle, label: "Scattered", value: "scattered", gradient: "from-[var(--cm-scattered-from)] via-[var(--cm-scattered-via)] to-[var(--cm-scattered-to)]", iconTone: "text-indigo-500", tagline: "Hard to focus" },
];
