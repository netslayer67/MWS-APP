                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-4 text-xs text-muted-foreground mb-2">
                                    ...
                                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${activity.status === 'handled' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200' :
                                        activity.status === 'acknowledged' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200' :
