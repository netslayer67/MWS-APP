                        ...
                        >
                            <div className="text-center space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground italic">
                                    e.g., 'Had a challenging meeting this morning...' or 'Feeling grateful for team support...'
                                </p>
                            ...
                            <div className="flex gap-3 pt-2">
                                <Button
                                    onClick={() => navigate('/emotional-checkin/dashboard')}
                                    variant="outline"
                                    className="flex-1"
                                >
                                    Skip for Now
                                ...
                                <Button
                                    ...
                                    disabled={!userReflection.trim() || isSubmitting}
